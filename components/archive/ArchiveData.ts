...
export const archiveObjects: ArchiveDeskObject[] = [
  {
    ...
    decorations: [
      {
        id: 'labPaperclip',
        assetSrc: '/archive/phase-1/accessories/paperclip-silver.webp',
        assetWidth: 250,
        assetHeight: 409,
        layer: 'over',
        mobile: 'hide'
  ...
  },
  {
    ...
    decorations: [
      {
        id: 'workClip',
        assetSrc: '/archive/phase-1/accessories/binder-clip-brass.webp',
        assetWidth: 350,
        assetHeight: 336,
        layer: 'over',
        mobile: 'hide'
      ...
      {
        id: 'workTab',
        assetSrc: '/archive/phase-1/accessories/index-tab-coral.webp',
        assetWidth: 250,
        assetHeight: 185,
        layer: 'under',
        mobile: 'keep'
