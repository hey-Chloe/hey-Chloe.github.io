...
import ArchiveObject, { ARCHIVE_LAYOUT_STORAGE_KEY } from './ArchiveObject';
import { archiveObjects, type ArchiveObjectId } from './ArchiveData';
import ChloesArchiveWordmark from './ChloesArchiveWordmark';
  ...
  return (
    <section className={styles.section} aria-labelledby="archive-title">
      <div className={styles.stage} data-ready="true" data-router="five-worlds"
        style={{ '--archive-marble-texture': `url("${assetPath('/images/pearl-marble-texture.svg')}")` } as CSSProperties}>
