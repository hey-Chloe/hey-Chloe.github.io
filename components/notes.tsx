...
export async function NotesList({limit,locale="zh"}:{limit?:number;locale?:Locale}) {
 const notes=await getNotes();const {siteCopy}=localizedContent(locale);const l=labels(locale);
