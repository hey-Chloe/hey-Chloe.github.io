...
export function PublicationList({ locale="zh" }: { locale?:Locale }) {
  ...
  if (!publications.length) {
    const { siteCopy } = localizedContent(locale);
    return <EmptyState locale={locale} title={siteCopy.publications.emptyTitle} description={siteCopy.publications.emptyDescription} />;
  }
