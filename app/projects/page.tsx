...
const projects = [
  ['Static Blog', 'Next.js + TypeScript + Tailwind CSS + Markdown，部署在 GitHub Pages。'],
  ['Web Security Notes', 'HTTP、SQL 注入、XSS、文件上传和认证授权的学习整理。'],
  ['CTF Writeups', 'Web 方向题目的入口、payload、卡点和复盘。'],
  ['Java Practice Lab', 'Java 基础语法、面向对象、集合与异常处理练习。']
];
