...
const projects = [
  ...
  { number: '04', title: 'Chloe Archive', eyebrow: 'This website', description: '使用 Next.js、TypeScript 与 Markdown 构建的个人数字档案馆，并部署在 GitHub Pages。', result: '把项目、笔记与持续学习的轨迹收拢成一个长期生长的个人空间。', tags: ['Next.js', 'TypeScript', 'Markdown'], href: 'https://github.com/hey-Chloe/hey-Chloe.github.io', visual: 'archive', external: true }
] as const;
...
function ProjectVisual({ type }: { type: (typeof projects)[number]['visual'] }) {
  ...
  return <div className="result-visual result-archive" aria-label="Chloe Archive 页面结构示意图"><div className="archive-mini-logo">Chloe Archive</div><div className="archive-mini-desk"><span>NOTES</span><span>PROJECTS</span><span>GARDEN</span><span>ABOUT</span></div><p>built to keep growing ↗</p></div>;
}
