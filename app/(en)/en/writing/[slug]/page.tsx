...
export async function generateMetadata({params}:Props){return noteMetadata((await params).slug,"en");}
export default async function Page({params}:Props){return <NoteContent slug={(await params).slug} locale="en"/>;}
